...
public class AspectConstants {
	 ...
	 */
	public static final String BASE_SERVICE_PACKAGE = " @annotation(org.qifu.base.aspect.EnableAspectForSimpleOrBaseServiceMethod) || execution(* org.qifu.core.service.*.*(..) ) || execution(* org.qifu.base.service.*.*(..) ) || execution(* org.qifu.md.service.*.*(..) ) ";
	
	/**
	 * 注意 base.service.logic.*.* 不是 base.service.logic..*.*
	 */
	public static final String LOGIC_SERVICE_PACKAGE = " @annotation(org.qifu.base.aspect.EnableAspectForLogicServiceMethod) || execution(* org.qifu.core.logic.*.*(..) ) || execution(* org.qifu.base.logic..*.*(..) ) || execution(* org.qifu.md.logic..*.*(..) ) ";
