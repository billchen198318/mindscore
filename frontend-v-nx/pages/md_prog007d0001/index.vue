...
import { useMdProg007d0001Store } from './QueryPageStore';
import {
    getAxiosInstance,
    getProgItem,
...
const queryPageStore = useMdProg007d0001Store();
...
const initQueryGridConfig = () => {
    return getGridConfig(
        ...
        [
            ...
            { label: 'Workspace Code', field: 'workspaceCode' },
            { label: 'Workspace Name', field: 'workspaceName' },
            { label: 'Vision', field: 'visionText' },
            { label: 'Mission', field: 'missionText' },
...
<div class="row">
  <div class="col-12">
    <Toolbar
        ...
        description="Strategy Workspace Query"
        refreshFlag="Y"
    ...
    <div class="row g-3">
      <div class="col-md-4">
        <div class="form-group form-floating">
          <input type="text" class="form-control" id="workspaceCode" placeholder="Workspace Code" v-model="queryPageStore.queryParam.workspaceCode">
          <label for="workspaceCode">Workspace Code</label>
        </div>
      </div>
      <div class="col-md-4">
        <div class="form-group form-floating">
          <input type="text" class="form-control" id="workspaceName" placeholder="Workspace Name" v-model="queryPageStore.queryParam.workspaceName">
