...
const parentItemOptions = computed(() => itemList.value.filter((item: any) => item.planOid === actionItem.value.planOid));
...
watch(() => actionItem.value.planOid, () => {
...
<div class="row">
    <div class="col-12">
        <Toolbar
            ...
            description="Action Item Create"
            refreshFlag="Y"
  ...
  <div class="card-body">
    <div class="row g-3">
      <div class="col-md-4">
        ...
        <select :class="['form-select', checkInvalid('planOid', checkFields) ? 'is-invalid' : '']" id="planOid" v-model="actionItem.planOid">
