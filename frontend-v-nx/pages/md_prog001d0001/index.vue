...
import { useMdProg001d0001Store } from './QueryPageStore'; 
import { 
	getAxiosInstance, 
	getProgItem, 
...
const queryPageStore = useMdProg001d0001Store();
...
const btnClear = () => {
	queryPageStore.queryParam.orgCode = '';
	queryPageStore.queryParam.orgName = '';
	dsList.value = [];
	clearGridConfig();
};
...
const initQueryGridConfig = () => {
  	return getGridConfig(
		...
		[
			...
			{ label: '組織代碼', field: 'orgCode' },
			{ label: '組織名稱', field: 'orgName' },
			{ label: '組織層級', field: 'orgLevel' }
		]    
	);
};
    ...
    <div class="row g-3">
      <div class="col-md-6">
        <div class="form-group form-floating">
          <input type="text" class="form-control" id="orgCode" placeholder="輸入組織代碼" v-model="queryPageStore.queryParam.orgCode">
          <label for="orgCode">組織代碼</label>
        </div>
      </div>
      <div class="col-md-6">
        <div class="form-group form-floating">
          <input type="text" class="form-control" id="orgName" placeholder="輸入組織名稱" v-model="queryPageStore.queryParam.orgName">
