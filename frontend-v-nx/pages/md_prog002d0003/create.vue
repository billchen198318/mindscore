...
const btnClear = () => {
    ...
    formParam.value.recommendedFormulaOid = pleaseSelectId;
  ...
  <div class="card-body">
    <div class="row g-3">
      <div class="col-md-4">
        ...
        <input type="text" :class="['form-control', checkInvalid('ruleCode', checkFields) ? 'is-invalid' : '']" id="ruleCode" v-model="formParam.ruleCode" placeholder="輸入規則代碼">
